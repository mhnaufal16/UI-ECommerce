...
Route::get('/dashboard/orders/{id}/tracking', fn($id) => view('pages.user.tracking', ['orderId' => $id]))->name('user.tracking');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/shipping', fn() => view('pages.admin.orders.tracking'))->name('shipping');
